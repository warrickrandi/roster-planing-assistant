...
from assign_event import assign,unassign
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            "content": "You are an expert in converting English questions to SQL query!"
                       ...
                       "\n\n\Definatio for the CrewType as follow CP - Captain, FO - First Officer, CS - Cabin Supervisor, CC - Cabin Crew"
                       ...
                       "for select queries please use column name to fetch instead of all(*) and all columns should fetch"
            },
            {
                "role":"user",
                "content" : input_promt
